...
<head>
    ...
    <%
        String M;
        try {
            M = session.getAttribute("msg").toString(); //从session里把msg拿出来，并赋值给M
        }catch (Exception e){
            M ="";
        }
    %>
...
<div class="container">
    <div class="form row">
        <form class="form-horizontal col-sm-offset-3 col-md-offset-3" id="login_form" action="user/login" method="post">
            ...
            <div class="col-sm-9 col-md-9">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control required" type="password" placeholder="Password" name="password" maxlength="32"/>
                </div>
                <div class="form-group">
